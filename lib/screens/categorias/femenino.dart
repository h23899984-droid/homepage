...
class FemeninoScreen extends StatefulWidget {
  const FemeninoScreen({super.key});

  @override
  State<FemeninoScreen> createState() => _FemeninoScreenState();
}

class _FemeninoScreenState extends State<FemeninoScreen> {
  List<dynamic> _products = [];
  bool _isLoading = true;
  String? _error;

  static const Color _accentColor = Color(0xFF5C1A3A);
  ...
  Future<void> _fetchProducts() async {
    ...
    try {
      final data = await ApiService.getProductsByCategory('femenino');
        ...
        children: [
          ...
          TextButton(
            ...
            child: const Text('Actualizar',
                style: TextStyle(color: Color(0xFF5C1A3A))),
          ),
        ],
      ),
    );
